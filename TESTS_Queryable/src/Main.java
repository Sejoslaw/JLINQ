...
public class Main {
	...
	private static void testMySQLQueries() {
		...
		IQueryableJLinqWrapper<Customer> mySqlQuery = new MySqlQueryableJLinqWrapper<>(xamppConnection, "mycustomers");
		...
		mySqlQuery = new MySqlQueryableJLinqWrapper<>(xamppConnection);
		mySqlQuery.forEach(customer -> System.out.println(customer));
	}
